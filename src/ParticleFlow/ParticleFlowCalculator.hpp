...
//!
//! Task used for the analysis of Flow particle distributions. As for other tasks classes of this package, use event filters and particle filters to determine the
//! event selection and particle types and kinematic ranges across which Flow particle distributions are studied. Flow particle distributions are computed
//! (histogrammed) with instances of the ParticleFlowHistos class. The behavior of the class, i.e., what type and the range of filled histograms are determined by
...
//!
class ParticleFlowCalculator : public EventTask
{
public:
