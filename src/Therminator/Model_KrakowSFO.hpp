 ...
 *   \nonumber\\ \nonumber\\
 *   d\Sigamp_\mu p^\mu	&=& \left[ \sqrt{\tau_C^2 + \rho^2} \cosh(\eta_\parallel - y) - \rho \,p_T \cos(\phi - \phi_p)\right] \,\rho \,d\rho \,d\phi \,d\eta_\parallel \nonumber \nonumber \\
 ...
 *
 * @fn void Model_KrakowSFO::addPropertyBranch(TTree* aTree)
 ...
 *
 * @var double Model_KrakowSFO::momentumRapidityRange
 * @brief @f$ Y^{rng} @f$, rapidity range
 *
 * @var double Model_KrakowSFO::spatialRapidityRange
 * @brief @f$ \eta_\parallel^{rng} @f$, spatial rapidity range
 *
 * @var double Model_KrakowSFO::rhoMax
 * @brief @f$ \rho_{ampx} \,[GeV^{-1}] @f$, size of the fire-cylinder
 *
 * @var double Model_KrakowSFO::tauC
 ...
 *
 * @var Thermodynamics* Model_KrakowSFO::thermodynamics
