...
class Model : public  NamedObject, public ConfigurationManager
{
public:
  Model();
  virtual ~Model() {};
  ...
  virtual void   print(std::ostream & output=std::cout, int style=4, int size=50) const;
 ...
 *
 * @fn void Model::addPropertyBranch(TTree* aTree)
 ...
 *
 * @fn void Model::CalculateHash(String aPreHash)
