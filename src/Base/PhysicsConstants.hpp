...
//! 1 dalton = 1 Da = 1 u  = 1.66053906660(50)×10−27 kg
//!
constexpr double amu_GeV()
{
  return 0.9314941024228;
}
...
//!
constexpr double kilogramToMeV()
{
  return 5.6095861672249E+29;
}
...
//!
constexpr double protonMass()
{
  return 0.9382720881629;
}
...
//!
constexpr double neutronMass()
{
  return  0.9395654205254;
}
...
//!
constexpr double deuteronMass()
{
  return   1.87561292812 ;
}
//!
//!Triton Mass:
//! 5.007 356 7446 x 10-27 kg
//!
constexpr double tritonMass()
{
  return   3.01604928 * amu_GeV();
}
//!
//!helium3 Mass:
//! 3.0160293 u
//!
constexpr double helium3Mass()
{
  return   3.0160293  * amu_GeV();
}
...
//! 4.00260 u
//!
constexpr double helium4Mass()
{
  return   4.00260 * amu_GeV();
}
//!
//!Gold 197
//!196.966552 u
//!
constexpr double au197Mass()
{
  return   196.966552 * amu_GeV();
}
...
//!196.966552 u
//!
constexpr double pb208Mass()
{
  return   207.97665 * amu_GeV();
}
