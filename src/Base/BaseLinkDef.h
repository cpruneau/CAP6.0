...
#pragma link C++ class CAP::EnvironmentVariables+;
#pragma link C++ class CAP::FileIterator+;
#pragma link C++ class CAP::NamedObject+;
...
#pragma link C++ class CAP::TaskAccountant+;
