...
#ifndef CAP__VectorField
#define CAP__VectorField
#include "Aliases.hpp"
...
class VectorField : public NamedObject
{
public:
  // OPERATORS
  ...
  VectorField(const String & aName, double constValue);

  VectorField(const String & aName,
