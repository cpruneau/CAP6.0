 ...
 *
 * *********************************************************************/
#ifndef CAP__ParticleSingleCalculator
#define CAP__ParticleSingleCalculator
...
//!
class ParticleSingleCalculator : public EventTask
{
public:
  
  ParticleSingleCalculator();
  ParticleSingleCalculator(const ParticleSingleCalculator & calculator);
  ParticleSingleCalculator & operator=(const ParticleSingleCalculator & calculator);
...
#endif /* CAP__ParticleSingleCalculator */
