...
public:
  ...
  ParticleSingleHistos(const ParticleSingleHistos & group);
  ParticleSingleHistos & operator=(const ParticleSingleHistos & group);
  virtual ~ParticleSingleHistos(){ }
  virtual void cloneAll(const ParticleSingleHistos & group);
