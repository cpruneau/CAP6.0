...
void ParticlePairBfHistos::importHistograms(TFile & inputFile)
{
  ...
  h_C2_CD_DetaDphi    = loadH2(inputFile,createName(bn,"C2_CD_DetaDphi"));
  h_C2_CI_DetaDphi    = loadH2(inputFile,createName(bn,"C2_CI_DetaDphi"));
  h_C2N_B12_DetaDphi  = loadH2(inputFile,createName(bn,"C2N_B12_DetaDphi"));
  h_C2N_B21_DetaDphi  = loadH2(inputFile,createName(bn,"C2N_B21_DetaDphi"));
  h_C2N_Bs_DetaDphi   = loadH2(inputFile,createName(bn,"C2N_Bs_DetaDphi"));
  h_R2_B12_DetaDphi   = loadH2(inputFile,createName(bn,"R2_B12_DetaDphi"));
  h_R2_B21_DetaDphi   = loadH2(inputFile,createName(bn,"R2_B21_DetaDphi"));
  h_R2_Bs_DetaDphi    = loadH2(inputFile,createName(bn,"R2_Bs_DetaDphi"));

  h_C2_CD_DyDphi     = loadH2(inputFile,createName(bn,"C2_CD_DyDphi"));
  h_C2_CI_DyDphi     = loadH2(inputFile,createName(bn,"C2_CI_DyDphi"));
  h_C2N_B12_DyDphi   = loadH2(inputFile,createName(bn,"C2N_B12_DyDphi"));
  h_C2N_B21_DyDphi   = loadH2(inputFile,createName(bn,"C2N_B21_DyDphi"));
  h_C2N_Bs_DyDphi    = loadH2(inputFile,createName(bn,"C2N_Bs_DyDphi"));
  h_R2_B12_DyDphi    = loadH2(inputFile,createName(bn,"R2_B12_DyDphi"));
  h_R2_B21_DyDphi    = loadH2(inputFile,createName(bn,"R2_B21_DyDphi"));
  h_R2_Bs_DyDphi     = loadH2(inputFile,createName(bn,"R2_Bs_DyDphi"));
}
                                                 ...
                                                 ParticlePairDerivedHistos & pair21)
{
  ...
  h_C2_CD_DetaDphi   ->Add(pair21B.h_C2_DetaDphi,pair2B1B.h_C2_DetaDphi,1.0,-1.0);
  h_C2_CD_DetaDphi   ->Add(pair2B1.h_C2_DetaDphi,+1.0);
  h_C2_CD_DetaDphi   ->Add(pair21.h_C2_DetaDphi, -1.0);
  h_C2_CI_DetaDphi   ->Add(pair21B.h_C2_DetaDphi,pair2B1B.h_C2_DetaDphi,1.0,1.0);
  h_C2_CI_DetaDphi   ->Add(pair2B1.h_C2_DetaDphi,+1.0);
  h_C2_CI_DetaDphi   ->Add(pair21.h_C2_DetaDphi, +1.0);
  h_C2N_B12_DetaDphi ->Add(pair21B.h_C2_DetaDphi,pair2B1B.h_C2_DetaDphi,1.0,-1.0);
  h_C2N_B21_DetaDphi ->Add(pair2B1.h_C2_DetaDphi,pair21.h_C2_DetaDphi,1.0,-1.0);
  h_C2N_Bs_DetaDphi  ->Add(h_C2N_B12_DetaDphi,h_C2N_B21_DetaDphi,0.5,0.5);
  h_R2_B12_DetaDphi  ->Add(pair21B.h_R2_DetaDphi,pair2B1B.h_R2_DetaDphi,1.0,-1.0);
  h_R2_B21_DetaDphi  ->Add(pair2B1.h_R2_DetaDphi,pair21.h_R2_DetaDphi,1.0,-1.0);
  h_R2_Bs_DetaDphi   ->Add(h_R2_B12_DetaDphi,h_R2_B21_DetaDphi,0.5,0.5);

  h_C2_CD_DyDphi   ->Add(pair21B.h_C2_DyDphi,pair2B1B.h_C2_DyDphi,1.0,-1.0);
  h_C2_CD_DyDphi   ->Add(pair2B1.h_C2_DyDphi,+1.0);
  h_C2_CD_DyDphi   ->Add(pair21.h_C2_DyDphi, -1.0);
  h_C2_CI_DyDphi   ->Add(pair21B.h_C2_DyDphi,pair2B1B.h_C2_DyDphi,1.0,1.0);
  h_C2_CI_DyDphi   ->Add(pair2B1.h_C2_DyDphi,+1.0);
  h_C2_CI_DyDphi   ->Add(pair21.h_C2_DyDphi, +1.0);
  h_C2N_B12_DyDphi ->Add(pair21B.h_C2_DyDphi,pair2B1B.h_C2_DyDphi,1.0,-1.0);
  h_C2N_B21_DyDphi ->Add(pair2B1.h_C2_DyDphi,pair21.h_C2_DyDphi,1.0,-1.0);
  h_C2N_Bs_DyDphi  ->Add(h_C2N_B12_DyDphi,h_C2N_B21_DyDphi,0.5,0.5);
  h_R2_B12_DyDphi  ->Add(pair21B.h_R2_DyDphi,pair2B1B.h_R2_DyDphi,1.0,-1.0);
  h_R2_B21_DyDphi  ->Add(pair2B1.h_R2_DyDphi,pair21.h_R2_DyDphi,1.0,-1.0);
