  ...
  switch (choice)
    {
      ...
      plotter->deltaY_Minimum = -20.0;
      plotter->deltaY_Maximum = 20.0;
      plotter->bf_General_Titles.push_back(TString("Therminator; T=140,180 MeV"));
      plotter->outputPathNameBase = "/Volumes/ClaudeDisc4/OutputFiles/Therminator/";
      plotter->outputFileNameBase = "Therminator_piKp_A2Based_";

      plotter->addSystem("/Volumes/ClaudeDisc4/OutputFiles/Therminator/allResT140/",
                         ...
                         bf_Width_DeltaYMin,
                         bf_Width_DeltaYMax);
      plotter->addSystem("/Volumes/ClaudeDisc4/OutputFiles/Therminator/allResT180/",
                         "PairGenBalFctSum0TO39.root",
                         "T=180 MeV",
                         "PairGen_All_",
                         "PairGen_All_",
