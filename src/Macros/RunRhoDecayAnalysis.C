...
int RunRhoDecayAnalysis()
{
  ...
  if (runEventAnalysis)
    ...
    eventAnalysis = new EventIterator("EventIterator",eventAnalysisConfig,selectedLevel);
...
//      performConfig.addParameter(baseName+"_PhiRmsA2",   0.0);
  ...
  if (runPerformAnalysis)
    ...
    task = new PerformanceAnalyzer(simAnaLabel,performAnaConfig,performAnaEventFilters,performAnaParticleFilters,selectedLevel);
