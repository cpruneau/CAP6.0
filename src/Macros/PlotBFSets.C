            ...
            int  plotIntegralVsLogY=1)
{
  ...
  for (unsigned int iFile=0; iFile<histoInputFileNames.size(); iFile++)
    ...
    switch (histoTypes[iFile])
      {
        case 0:
        bDeltaYProjName   = "Pythia_PPvsS_B2_1Bar_2_VsDeltaRapidity";
        bDeltaPhiProjName = "Pythia_PPvsS_B2_1Bar_2_VsDeltaPhi";
        integralName      = "Pythia_PPvsS_I2_1Bar_2";
    ...
    cout << "2D plots are complted" << endl;
  ...
  switch (option)
    {
      ...
      titles.push_back(TString("pp #sqrt{s} = 0.9 TeV"));
      histoTypes.push_back(0);
      histoNames2D.push_back(TString("PairGen_All_HP_HP_B2_DyDphi_shft_B2_1Bar_2"));
      histoNames1DVsDeltaY.push_back(TString("PairGen_All_HP_HP_B2_DyDphi_shft_B2_1Bar_2_x"));
      histoNames1DVsDeltaPhi.push_back(TString("PairGen_All_HP_HP_B2_DyDphi_shft_B2_1Bar_2_y"));
      ...
      histoNames1DVsDeltaY.push_back(TString("PairGen_All_HP_HP_B2_DyDphi_shft_B2_1_2Bar_x"));
      histoNames1DVsDeltaPhi.push_back(TString("PairGen_All_HP_HP_B2_DyDphi_shft_B2_1_2Bar_y"));
      ...
      histoNames1DVsDeltaY.push_back(TString("PairGen_All_HP_HP_B2_DyDphi_shft_B2_12Sum_x"));
      histoNames1DVsDeltaPhi.push_back(TString("PairGen_All_HP_HP_B2_DyDphi_shft_B2_12Sum_y"));
...
// -----
      ...
      histoTypes.push_back(0);
      titles.push_back(TString("pp #sqrt{s} = 2.76 TeV"));
      histoNames2D.push_back(TString("PairGen_All_HP_HP_B2_DyDphi_shft_B2_1Bar_2"));
      histoNames1DVsDeltaY.push_back(TString("PairGen_All_HP_HP_B2_DyDphi_shft_B2_1Bar_2_x"));
      histoNames1DVsDeltaPhi.push_back(TString("PairGen_All_HP_HP_B2_DyDphi_shft_B2_1Bar_2_y"));
      ...
      titles.push_back(TString("pp #sqrt{s} = 5.02 TeV"));
      histoTypes.push_back(0);
      histoNames2D.push_back(TString( "PairGen_All_HP_HP_B2_DyDphi_shft_B2_1Bar_2"));
      histoNames1DVsDeltaY.push_back(TString("PairGen_All_HP_HP_B2_DyDphi_shft_B2_1Bar_2_x"));
      histoNames1DVsDeltaPhi.push_back(TString("PairGen_All_HP_HP_B2_DyDphi_shft_B2_1Bar_2_y"));
      ...
      if (rebin)
        titles.push_back(TString("(a) pp #sqrt{s} = 13.0 TeV"));
      else
      ...
      titles.push_back(TString("p#bar{p} #sqrt{s} = 13.0 TeV"));
      histoTypes.push_back(0);
      histoNames2D.push_back(TString( "PairGen_All_HP_HP_B2_DyDphi_shft_B2_1Bar_2"));
      histoNames1DVsDeltaY.push_back(TString("PairGen_All_HP_HP_B2_DyDphi_shft_B2_1Bar_2_x"));
      histoNames1DVsDeltaPhi.push_back(TString("PairGen_All_HP_HP_B2_DyDphi_shft_B2_1Bar_2_y"));
      ...
      histoNames1DVsDeltaY.push_back(TString("PairGen_All_HP_HP_A2_DyDphi_shft_B2_1Bar_2_x"));
      histoNames1DVsDeltaPhi.push_back(TString("PairGen_All_HP_HP_A2_DyDphi_shft_B2_1Bar_2_y"));
      ...
      histoNames1DVsDeltaY.push_back(TString("PairGen_All_HP_HP_A2_DyDphi_shft_B2_1_2Bar_x"));
      histoNames1DVsDeltaPhi.push_back(TString("PairGen_All_HP_HP_A2_DyDphi_shft_B2_1_2Bar_y"));
      ...
      histoNames1DVsDeltaY.push_back(TString("PairGen_All_HP_HP_A2_DyDphi_shft_B2_12Sum_x"));
      histoNames1DVsDeltaPhi.push_back(TString("PairGen_All_HP_HP_A2_DyDphi_shft_B2_12Sum_y"));
...
//----
      ...
      names.push_back(TString("PYTHIA_pp_13TeV_Y1_A2Based_B2_12Sum"));
      ...
      names.push_back(TString("PYTHIA_pp_13TeV_Y2_A2Based_B2_12Sum"));
      ...
      names.push_back(TString("PYTHIA_pp_13TeV_Y4_A2Based_B2_12Sum"));
      ...
      histoInputFileNames.push_back(TString("PP/13000/PM/Y10/PairGenBalFctSum0TO4.root"));
      names.push_back(TString("PYTHIA_pp_13TeV_Y10_A2Based_B2_12Sum"));
      ...
      titles.push_back(TString("0 < p_{T} < 10 GeV/c"));
      histoTypes.push_back(2);
      histoNames2D.push_back(TString( "PairGen_All_HP_HP_A2_DyDphi_shft_B2_12Sum"));
      histoNames1DVsDeltaY.push_back(TString("PairGen_All_HP_HP_A2_DyDphi_shft_B2_12Sum_x"));
      histoNames1DVsDeltaPhi.push_back(TString("PairGen_All_HP_HP_A2_DyDphi_shft_B2_12Sum_y"));
