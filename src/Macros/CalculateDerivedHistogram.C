  ...
  if (computeDerivedHistograms)
    {
     if (doParticles)
      ...
      FileIterator * iterator = new FileIterator("ParticleDerivedHistogramIterator",fileIteratorConfig,selectedLevel);
    ...
    if (doNuDyns)
      ...
      fileIteratorConfig.addParameter("ExcludedPattern2",balFctLabel);
      fileIteratorConfig.addParameter("appendedString",  derivedLabel);
      FileIterator * iterator = new FileIterator("NuDynDerivedHistogramIterator",fileIteratorConfig,selectedLevel);
