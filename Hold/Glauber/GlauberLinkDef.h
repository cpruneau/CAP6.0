...
#pragma link C++ class CAP::IdentifiedObject+;
#pragma link C++ class CAP::Timer+;
#pragma link C++ class CAP::Counter+;
#pragma link C++ class CAP::Configuration+;
#pragma link C++ class CAP::ConfigurationManager+;
#pragma link C++ class CAP::Parser+;
#pragma link C++ class CAP::TextParser+;
#pragma link C++ class CAP::XmlParser+;
#pragma link C++ class CAP::XmlDocument+;
...
#pragma link C++ class CAP::Factory<CAP::VectorField>+;
#pragma link C++ class CAP::PrintHelper+;
...
#pragma link C++ class CAP::FileManager+;
...
#pragma link C++ class CAP::VectorField+;
#pragma link C++ class CAP::XmlVectorField+;
#endif
