      ...
      switch (selectedSystem)
        {
          ...
          function->addProperty(0,20.251); // Z
          function->addProperty(1,7.572); // X
          function->addProperty(2,0.132); // eps
          function->addProperty(3,74.811); // Y1
          function->addProperty(4,29.918); // Y2
          function->addProperty(5,0.48); // alpha0
          break;
          ...
          function = new TF1(functionName,GauronModelF1, minSqrtS, maxSqrtS, 6);
          function->addProperty(0,5.283); // Z
          function->addProperty(1,7.572); // X
          function->addProperty(2,0.132); // eps
          function->addProperty(3,48.972); // Y1
          function->addProperty(4,6.028); // Y2
          function->addProperty(5,0.48); // alpha0
          break;
          ...
          function = new TF1(functionName,GauronModelF1, minSqrtS, maxSqrtS, 6);
          function->addProperty(0,2.208); // Z
          function->addProperty(1,7.572); // X
          function->addProperty(2,0.132); // eps
          function->addProperty(3,34.483); // Y1
          function->addProperty(4,11.935); // Y2
          function->addProperty(5,0.48); // alpha0
          break;
          ...
          function->addProperty(0,0.303E-2); // delta
          function->addProperty(1,20.251);    // Z
          function->addProperty(2,7.572);    // X
          function->addProperty(3,0.132);   // eps
          function->addProperty(4,0.121);   // Y1
          function->addProperty(5,0.48);   // alpha0
          break;
          case GammaGammaCollisions:
          functionName = "GauronGammaGammaCollisions";
          function = new TF1(functionName,GauronGammaModelF1, minSqrtS, maxSqrtS, 6);
          function->addProperty(0,0.303E-2*0.303E-2); // delta^2
          function->addProperty(1,20.251);    // Z
          function->addProperty(2,7.572);    // X
          function->addProperty(3,0.132);   // eps
          function->addProperty(4,0.0);   // Y1
          function->addProperty(5,0.48);   // alpha0
          break;
        }
      break;
