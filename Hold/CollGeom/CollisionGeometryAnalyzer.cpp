...
collisionGeometry(nullptr)
{
  ...
  setName("CollisionGeometry");
  setTitle("CollisionGeometry");
  setVersion("1.0");
  setDescription("CollisionGeometry");
}
...
void CollisionGeometryAnalyzer::configure()
{
  EventTask::configure();
}
...
void CollisionGeometryAnalyzer::createHistograms()
{
  ...
  HistogramTask.addSet("CollisionGeometry");
...
void CollisionGeometryAnalyzer::execute()
{
  ...
  for (int iEventFilter=0; iEventFilter<nEventFilters; iEventFilter++ )
    ...
    if (eventFilters[iEventFilter]->accept(event))
      ...
      CollisionGeometryHistograms * histos = (CollisionGeometryHistograms *)  HistogramTask.getGroup(0,iEventFilter);
