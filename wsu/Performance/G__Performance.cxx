...
namespace ROOT {
   ...
   static void *new_CAPcLcLResolutionFunction(void *p = nullptr);
   static void *newArray_CAPcLcLResolutionFunction(Long_t size, void *p);
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::CAP::ResolutionFunction*)
   {
      ...
      instance.SetNew(&new_CAPcLcLResolutionFunction);
      instance.SetNewArray(&newArray_CAPcLcLResolutionFunction);
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::CAP::MeasurementSimulator*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("CAP::MeasurementSimulator", ::CAP::MeasurementSimulator::Class_Version(), "MeasurementSimulator.hpp", 37,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::CAP::EventPlaneRandomizerTask*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("CAP::EventPlaneRandomizerTask", ::CAP::EventPlaneRandomizerTask::Class_Version(), "EventPlaneRandomizerTask.hpp", 22,
...
namespace ROOT {
   ...
   static void *new_CAPcLcLResolutionFunction(void *p) {
      return  p ? ::new(static_cast<::ROOT::Internal::TOperatorNewHelper*>(p)) ::CAP::ResolutionFunction : new ::CAP::ResolutionFunction;
   }
   static void *newArray_CAPcLcLResolutionFunction(Long_t nElements, void *p) {
      return p ? ::new(static_cast<::ROOT::Internal::TOperatorNewHelper*>(p)) ::CAP::ResolutionFunction[nElements] : new ::CAP::ResolutionFunction[nElements];
   }
...
"/opt/homebrew/Cellar/root/6.32.06/include/root",
"/Users/aa7526/Documents/GitHub/CAP7.0/wsu/Performance/",
nullptr
    };
...
namespace CAP{class __attribute__((annotate("$clingAutoload$ResolutionFunction.hpp")))  __attribute__((annotate("$clingAutoload$MeasurementSimulator.hpp")))  ResolutionFunction;}
