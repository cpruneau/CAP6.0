...
namespace ROOT {
   static TClass *CAPcLcLManagerlECAPcLcLEfficiencyFiltergR_Dictionary();
   static void CAPcLcLManagerlECAPcLcLEfficiencyFiltergR_TClassManip(TClass*);
   static void *new_CAPcLcLManagerlECAPcLcLEfficiencyFiltergR(void *p = nullptr);
   static void *newArray_CAPcLcLManagerlECAPcLcLEfficiencyFiltergR(Long_t size, void *p);
   static void delete_CAPcLcLManagerlECAPcLcLEfficiencyFiltergR(void *p);
   static void deleteArray_CAPcLcLManagerlECAPcLcLEfficiencyFiltergR(void *p);
   static void destruct_CAPcLcLManagerlECAPcLcLEfficiencyFiltergR(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::CAP::Manager<CAP::EfficiencyFilter>*)
   {
      ::CAP::Manager<CAP::EfficiencyFilter> *ptr = nullptr;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::CAP::Manager<CAP::EfficiencyFilter> >(nullptr);
      static ::ROOT::TGenericClassInfo 
         instance("CAP::Manager<CAP::EfficiencyFilter>", ::CAP::Manager<CAP::EfficiencyFilter>::Class_Version(), "Manager.hpp", 33,
                  typeid(::CAP::Manager<CAP::EfficiencyFilter>), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &CAPcLcLManagerlECAPcLcLEfficiencyFiltergR_Dictionary, isa_proxy, 4,
                  sizeof(::CAP::Manager<CAP::EfficiencyFilter>) );
      instance.SetNew(&new_CAPcLcLManagerlECAPcLcLEfficiencyFiltergR);
      instance.SetNewArray(&newArray_CAPcLcLManagerlECAPcLcLEfficiencyFiltergR);
      instance.SetDelete(&delete_CAPcLcLManagerlECAPcLcLEfficiencyFiltergR);
      instance.SetDeleteArray(&deleteArray_CAPcLcLManagerlECAPcLcLEfficiencyFiltergR);
      instance.SetDestructor(&destruct_CAPcLcLManagerlECAPcLcLEfficiencyFiltergR);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::CAP::Manager<CAP::EfficiencyFilter>*)
   {
      return GenerateInitInstanceLocal(static_cast<::CAP::Manager<CAP::EfficiencyFilter>*>(nullptr));
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal(static_cast<const ::CAP::Manager<CAP::EfficiencyFilter>*>(nullptr)); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *CAPcLcLManagerlECAPcLcLEfficiencyFiltergR_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal(static_cast<const ::CAP::Manager<CAP::EfficiencyFilter>*>(nullptr))->GetClass();
      CAPcLcLManagerlECAPcLcLEfficiencyFiltergR_TClassManip(theClass);
   return theClass;
   }
...
namespace ROOT {
   static void *new_CAPcLcLEfficiencyFilter(void *p = nullptr);
   static void *newArray_CAPcLcLEfficiencyFilter(Long_t size, void *p);
   static void delete_CAPcLcLEfficiencyFilter(void *p);
   static void deleteArray_CAPcLcLEfficiencyFilter(void *p);
   static void destruct_CAPcLcLEfficiencyFilter(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::CAP::EfficiencyFilter*)
   {
      ::CAP::EfficiencyFilter *ptr = nullptr;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::CAP::EfficiencyFilter >(nullptr);
      static ::ROOT::TGenericClassInfo 
         instance("CAP::EfficiencyFilter", ::CAP::EfficiencyFilter::Class_Version(), "EfficiencyFilter.hpp", 19,
                  typeid(::CAP::EfficiencyFilter), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &::CAP::EfficiencyFilter::Dictionary, isa_proxy, 4,
                  sizeof(::CAP::EfficiencyFilter) );
      instance.SetNew(&new_CAPcLcLEfficiencyFilter);
      instance.SetNewArray(&newArray_CAPcLcLEfficiencyFilter);
      instance.SetDelete(&delete_CAPcLcLEfficiencyFilter);
      instance.SetDeleteArray(&deleteArray_CAPcLcLEfficiencyFilter);
      instance.SetDestructor(&destruct_CAPcLcLEfficiencyFilter);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::CAP::EfficiencyFilter*)
   {
      return GenerateInitInstanceLocal(static_cast<::CAP::EfficiencyFilter*>(nullptr));
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal(static_cast<const ::CAP::EfficiencyFilter*>(nullptr)); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::CAP::EventTask*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("CAP::EventTask", ::CAP::EventTask::Class_Version(), "EventTask.hpp", 29,
...
namespace CAP {
//______________________________________________________________________________
template <> atomic_TClass_ptr Manager<CAP::EfficiencyFilter>::fgIsA(nullptr);  // static to hold class pointer

//______________________________________________________________________________
template <> const char *Manager<CAP::EfficiencyFilter>::Class_Name()
{
   return "CAP::Manager<CAP::EfficiencyFilter>";
}

//______________________________________________________________________________
template <> const char *Manager<CAP::EfficiencyFilter>::ImplFileName()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::CAP::Manager<CAP::EfficiencyFilter>*)nullptr)->GetImplFileName();
}

//______________________________________________________________________________
template <> int Manager<CAP::EfficiencyFilter>::ImplFileLine()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::CAP::Manager<CAP::EfficiencyFilter>*)nullptr)->GetImplFileLine();
}

//______________________________________________________________________________
template <> TClass *Manager<CAP::EfficiencyFilter>::Dictionary()
{
   fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::CAP::Manager<CAP::EfficiencyFilter>*)nullptr)->GetClass();
   return fgIsA;
}

//______________________________________________________________________________
template <> TClass *Manager<CAP::EfficiencyFilter>::Class()
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::CAP::Manager<CAP::EfficiencyFilter>*)nullptr)->GetClass(); }
   return fgIsA;
}
...
namespace CAP {
//______________________________________________________________________________
atomic_TClass_ptr EfficiencyFilter::fgIsA(nullptr);  // static to hold class pointer

//______________________________________________________________________________
const char *EfficiencyFilter::Class_Name()
{
   return "CAP::EfficiencyFilter";
}

//______________________________________________________________________________
const char *EfficiencyFilter::ImplFileName()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::CAP::EfficiencyFilter*)nullptr)->GetImplFileName();
}

//______________________________________________________________________________
int EfficiencyFilter::ImplFileLine()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::CAP::EfficiencyFilter*)nullptr)->GetImplFileLine();
}

//______________________________________________________________________________
TClass *EfficiencyFilter::Dictionary()
{
   fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::CAP::EfficiencyFilter*)nullptr)->GetClass();
   return fgIsA;
}

//______________________________________________________________________________
TClass *EfficiencyFilter::Class()
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::CAP::EfficiencyFilter*)nullptr)->GetClass(); }
   return fgIsA;
}
...
namespace CAP {
//______________________________________________________________________________
template <> void Manager<CAP::EfficiencyFilter>::Streamer(TBuffer &R__b)
{
   // Stream an object of class CAP::Manager<CAP::EfficiencyFilter>.

   if (R__b.IsReading()) {
      R__b.ReadClassBuffer(CAP::Manager<CAP::EfficiencyFilter>::Class(),this);
   } else {
      R__b.WriteClassBuffer(CAP::Manager<CAP::EfficiencyFilter>::Class(),this);
   }
}
...
namespace ROOT {
   // Wrappers around operator new
   static void *new_CAPcLcLManagerlECAPcLcLEfficiencyFiltergR(void *p) {
      return  p ? ::new(static_cast<::ROOT::Internal::TOperatorNewHelper*>(p)) ::CAP::Manager<CAP::EfficiencyFilter> : new ::CAP::Manager<CAP::EfficiencyFilter>;
   }
   static void *newArray_CAPcLcLManagerlECAPcLcLEfficiencyFiltergR(Long_t nElements, void *p) {
      return p ? ::new(static_cast<::ROOT::Internal::TOperatorNewHelper*>(p)) ::CAP::Manager<CAP::EfficiencyFilter>[nElements] : new ::CAP::Manager<CAP::EfficiencyFilter>[nElements];
   }
   // Wrapper around operator delete
   static void delete_CAPcLcLManagerlECAPcLcLEfficiencyFiltergR(void *p) {
      delete (static_cast<::CAP::Manager<CAP::EfficiencyFilter>*>(p));
   }
   static void deleteArray_CAPcLcLManagerlECAPcLcLEfficiencyFiltergR(void *p) {
      delete [] (static_cast<::CAP::Manager<CAP::EfficiencyFilter>*>(p));
   }
   static void destruct_CAPcLcLManagerlECAPcLcLEfficiencyFiltergR(void *p) {
      typedef ::CAP::Manager<CAP::EfficiencyFilter> current_t;
      (static_cast<current_t*>(p))->~current_t();
   }
} // end of namespace ROOT for class ::CAP::Manager<CAP::EfficiencyFilter>
...
namespace CAP {
//______________________________________________________________________________
void EfficiencyFilter::Streamer(TBuffer &R__b)
{
   // Stream an object of class CAP::EfficiencyFilter.

   if (R__b.IsReading()) {
      R__b.ReadClassBuffer(CAP::EfficiencyFilter::Class(),this);
   } else {
      R__b.WriteClassBuffer(CAP::EfficiencyFilter::Class(),this);
   }
}
...
namespace ROOT {
   // Wrappers around operator new
   static void *new_CAPcLcLEfficiencyFilter(void *p) {
      return  p ? ::new(static_cast<::ROOT::Internal::TOperatorNewHelper*>(p)) ::CAP::EfficiencyFilter : new ::CAP::EfficiencyFilter;
   }
   static void *newArray_CAPcLcLEfficiencyFilter(Long_t nElements, void *p) {
      return p ? ::new(static_cast<::ROOT::Internal::TOperatorNewHelper*>(p)) ::CAP::EfficiencyFilter[nElements] : new ::CAP::EfficiencyFilter[nElements];
   }
   // Wrapper around operator delete
   static void delete_CAPcLcLEfficiencyFilter(void *p) {
      delete (static_cast<::CAP::EfficiencyFilter*>(p));
   }
   static void deleteArray_CAPcLcLEfficiencyFilter(void *p) {
      delete [] (static_cast<::CAP::EfficiencyFilter*>(p));
   }
   static void destruct_CAPcLcLEfficiencyFilter(void *p) {
      typedef ::CAP::EfficiencyFilter current_t;
      (static_cast<current_t*>(p))->~current_t();
   }
} // end of namespace ROOT for class ::CAP::EfficiencyFilter
...
namespace ROOT {
   static TClass *vectorlECAPcLcLEfficiencyFiltermUgR_Dictionary();
   static void vectorlECAPcLcLEfficiencyFiltermUgR_TClassManip(TClass*);
   static void *new_vectorlECAPcLcLEfficiencyFiltermUgR(void *p = nullptr);
   static void *newArray_vectorlECAPcLcLEfficiencyFiltermUgR(Long_t size, void *p);
   static void delete_vectorlECAPcLcLEfficiencyFiltermUgR(void *p);
   static void deleteArray_vectorlECAPcLcLEfficiencyFiltermUgR(void *p);
   static void destruct_vectorlECAPcLcLEfficiencyFiltermUgR(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<CAP::EfficiencyFilter*>*)
   {
      vector<CAP::EfficiencyFilter*> *ptr = nullptr;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(vector<CAP::EfficiencyFilter*>));
      static ::ROOT::TGenericClassInfo 
         instance("vector<CAP::EfficiencyFilter*>", -2, "vector", 387,
                  typeid(vector<CAP::EfficiencyFilter*>), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &vectorlECAPcLcLEfficiencyFiltermUgR_Dictionary, isa_proxy, 0,
                  sizeof(vector<CAP::EfficiencyFilter*>) );
      instance.SetNew(&new_vectorlECAPcLcLEfficiencyFiltermUgR);
      instance.SetNewArray(&newArray_vectorlECAPcLcLEfficiencyFiltermUgR);
      instance.SetDelete(&delete_vectorlECAPcLcLEfficiencyFiltermUgR);
      instance.SetDeleteArray(&deleteArray_vectorlECAPcLcLEfficiencyFiltermUgR);
      instance.SetDestructor(&destruct_vectorlECAPcLcLEfficiencyFiltermUgR);
      instance.AdoptCollectionProxyInfo(TCollectionProxyInfo::Generate(TCollectionProxyInfo::Pushback< vector<CAP::EfficiencyFilter*> >()));

      instance.AdoptAlternate(::ROOT::AddClassAlternate("vector<CAP::EfficiencyFilter*>","std::__1::vector<CAP::EfficiencyFilter*, std::__1::allocator<CAP::EfficiencyFilter*>>"));
      return &instance;
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal(static_cast<const vector<CAP::EfficiencyFilter*>*>(nullptr)); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *vectorlECAPcLcLEfficiencyFiltermUgR_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal(static_cast<const vector<CAP::EfficiencyFilter*>*>(nullptr))->GetClass();
      vectorlECAPcLcLEfficiencyFiltermUgR_TClassManip(theClass);
   return theClass;
   }
...
namespace ROOT {
   // Wrappers around operator new
   static void *new_vectorlECAPcLcLEfficiencyFiltermUgR(void *p) {
      return  p ? ::new(static_cast<::ROOT::Internal::TOperatorNewHelper*>(p)) vector<CAP::EfficiencyFilter*> : new vector<CAP::EfficiencyFilter*>;
   }
   static void *newArray_vectorlECAPcLcLEfficiencyFiltermUgR(Long_t nElements, void *p) {
      return p ? ::new(static_cast<::ROOT::Internal::TOperatorNewHelper*>(p)) vector<CAP::EfficiencyFilter*>[nElements] : new vector<CAP::EfficiencyFilter*>[nElements];
   }
   // Wrapper around operator delete
   static void delete_vectorlECAPcLcLEfficiencyFiltermUgR(void *p) {
      delete (static_cast<vector<CAP::EfficiencyFilter*>*>(p));
   }
   static void deleteArray_vectorlECAPcLcLEfficiencyFiltermUgR(void *p) {
      delete [] (static_cast<vector<CAP::EfficiencyFilter*>*>(p));
   }
   static void destruct_vectorlECAPcLcLEfficiencyFiltermUgR(void *p) {
      typedef vector<CAP::EfficiencyFilter*> current_t;
      (static_cast<current_t*>(p))->~current_t();
   }
} // end of namespace ROOT for class vector<CAP::EfficiencyFilter*>
...
"/opt/homebrew/Cellar/root/6.32.06/include/root",
"/Users/aa7526/Documents/GitHub/CAP7.0/wsu/Particles/",
nullptr
    };
...
namespace CAP{class __attribute__((annotate("$clingAutoload$EfficiencyFilter.hpp")))  __attribute__((annotate("$clingAutoload$EventTask.hpp")))  EfficiencyFilter;}
...
"CAP::EfficiencyFilter", payloadCode, "@",
...
"CAP::Manager<CAP::EfficiencyFilter>", payloadCode, "@",
